...
class UsageInsightCardTest {
    ...
    @Test fun showsExplanationAndEvidence() {
        ...
        val state = UsageInsightUiState(
            ...
            UsageInsightFacts(
                UsageInsightRange(1786492800000, 1789084800000, "UTC"), "en",
        ...
        compose.onNodeWithText(context.getString(com.nagopy.android.foldlytics.R.string.insight_privacy_note))
            .assertIsDisplayed()
    ...
    @Test fun capturesBeforeAndAfterHomeWithSyntheticHistory() {
        ...
        val main = MainUiState(
            hasUsageAccess = true,
            recordRangeStartMillis = 1786492800000,
            recordRangeEndMillis = 1789084800000,
            lastSuccessfulSyncMillis = 1789084800000,
        ...
        compose.runOnIdle {
            insight.value = UsageInsightUiState(InsightStatus.READY,
                ...
                UsageInsightFacts(UsageInsightRange(1786492800000, 1789084800000, "UTC"),
    ...
    @Test fun hidesCardWhenModelIsNotAvailable() {
        compose.setContent { FoldlyticsTheme { UsageInsightCard(UsageInsightUiState()) } }
        compose.onNodeWithTag("usage_insight_card").assertDoesNotExist()
    }
}
