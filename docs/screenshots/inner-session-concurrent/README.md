...
The four English/Japanese detail images are synthetic UI fixtures with fixed example data; they demonstrate the before/after presentation and contain no captured usage history. Legacy attribution is rendered in the current card, not an older APK. The three `manual-` images are controlled emulator evidence.
